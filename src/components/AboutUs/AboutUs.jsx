...
const AboutUs = () => {
    return (
        <div className='flex pt-40 gap-12 pb-8 dark:bg-slate-950'>
            <div className='w-[40%] ml-20 relative'>
                <img className='rounded-2xl' src={aboutImg2} alt="" />
                <div className='absolute flex gap-4 bg-[#955E42] p-10 w-8/12 rounded-3xl bottom-24 -left-14'>
            ...
            <div className='w-1/2 mt-6 mr-5'>
                ...
                <div>
                    <h1 className='text-5xl font-bold font-Exo text-black mt-3 mb-5 dark:text-white'>Learn more about our mission, values, and the impact we've made.</h1>
